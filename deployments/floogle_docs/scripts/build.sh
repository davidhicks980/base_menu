...
flutter build web --dart-define=VISUALIZE_MENU_AIM=true --dart-define=FONT_PACKAGE=base_menu_demo --source-maps --wasm --release --pwa-strategy=none --tree-shake-icons -O4 -o "build/web/$PATH_KEY" --base-href "/$PATH_KEY/"
